...
<head>
    ...
    <meta name="desdription" content="Omnifood is a premium food delivery service with the mission to bring affordable and healthy meals to as many people as popssible." >
...
<body>
    ...
    <section class="section-features js--section-features" id="features">
        ...
        <div class="row js--wp-1">
            <div class="col span-1-of-4 box">
                ...
                <p>Never cook again! We really mean that. Our subscription plans include up to 
                    365 days/year coverage. You can also choose to order more flexibly if 
                    that's your style.  
                </p>
            </div>
            <div class="col span-1-of-4 box">
                ...
                <p>You're only twenty minutes away from your delicious and super healthy meals 
            ...
            <div class="col span-1-of-4 box">
                ...
                <p>All our vegetables are fresh, organic and local. Animals are raised without 
                    added hormones or antibiotics. Good for your health, the environment, 
                    and it also tastes better!  
                </p>
            </div>
            <div class="col span-1-of-4 box">
                <div class="ion-ios-cart-outline icon-big"></div>
    ...
    <section class="section-testimonials">
        ...
        <div class="row">
            <div class="col span-1-of-3">
                ...
                <cite><img src="resources/css/img/customer-1.jpg" alt="customer-1">Alberto Duncan</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                ...
                <cite><img src="resources/css/img/customer-2.jpg" alt="customer-2">Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                ...
                <cite><img src="resources/css/img/customer-3.jpg" alt="customer-3">Milton Chapman</cite>
                </blockquote>
            </div>
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    ...
                    <div>
                        <ul>
                            <li><i class="ion-ios-checkmark-empty icon-small"></i>1 meail every day</li>
    ...
    <footer>
        ...
        <div class="row">
            <p>
                Copyright &copy; 2020 by Omnifood. All rights
            </p>
        </div>
    </footer>
